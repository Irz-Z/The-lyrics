...
namespace TheLyrics.Api {
    /// <summary>
    /// Mark your Phonemizer class with this attribute for TheLyrics to load it.
    /// </summary>
    ...
    public abstract class Phonemizer {
        ...
        public struct Phoneme {
            ...
            /// Note that you don't have to return tone-mapped phonemes. TheLyrics will do it afterwards.
            /// I.e., you can simply return "あ" even when best match is actually "あC5".
            /// TheLyrics will try to find the most suitable tone for this phoneme, and tone-map based on it.
            /// </summary>
        ...
        /// <summary>
        /// Sets the current singer. Called by TheLyrics when user changes the singer.
        ///
        ...
        /// <summary>
        /// Used by TheLyrics to set timing info for TickToMs() and MsToTick().
