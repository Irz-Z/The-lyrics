...
namespace TheLyrics.App.ViewModels {
    public class PartsContextMenuArgs {
        ...
        // PartTranscribeCommand removed for The Lyrics
    }
    ...
    public class MainWindowViewModel : ViewModelBase, ICmdSubscriber {
        ...
        public string AppVersion => $"TheLyrics v{System.Reflection.Assembly.GetEntryAssembly()?.GetName().Version}";
