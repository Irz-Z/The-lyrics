    ...
    public class PathManager : SingletonBase<PathManager> {
        public PathManager() {
            ...
            if (OS.IsMacOS()) {
                ...
                DataPath = Path.Combine(userHome, "Library", "TheLyrics");
                CachePath = Path.Combine(userHome, "Library", "Caches", "TheLyrics");
                ...
                DataPath = Path.Combine(dataHome, "TheLyrics");
                ...
                CachePath = Path.Combine(cacheHome, "TheLyrics");
                HomePathIsAscii = true;
            } else {
